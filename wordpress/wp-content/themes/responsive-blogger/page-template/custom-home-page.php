...
<main id="content" class="mt-5">
    ...
    <div class="col-lg-6 col-md-6 media-post-pad">
      <div id="our-post">
        <div class="row">
          ...
          $page_query = new WP_Query(array( 'category_name' => esc_html($catData1 ,'responsive-blogger')));?>
          ...
          <?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
            <div class="col-lg-4 col-md-4">
              <div class="box">
                ...
                <div class="box-content">
                  <h4><?php the_title();?></h4>
                  <a href="<?php the_permalink(); ?>"><?php esc_html_e('LEARN MORE','responsive-blogger'); ?></a>
                </div>
              </div>
            </div>
          <?php endwhile;
  ...
  <?php if( get_theme_mod('responsive_blogger_horizontal_post_slider_arrows') != ''){ ?>
    <section id="horizontal-slider">
      <div class="container-fluid">
        <div id="carouselExampleIndicatorslide" class="carousel slide" data-ride="carousel"> 
          <?php
            for ( $i = 1; $i <= 4; $i++ ) {
              $mod =  get_theme_mod( 'responsive_blogger_horizontal_post_setting' . $i );
              if ( 'page-none-selected' != $mod ) {
                $slide_post[] = $mod;
              }
            }
          ...
          <div class="carousel-inner" role="listbox">
            <?php  while ( $query->have_posts() ) : $query->the_post(); ?>
            <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
              <div class="inner_carousel text-center text-lg-right text-md-right">
                <div class="row">
                  <div class="col-lg-6 col-md-6 order1">
                    <div class="p-3 p-lg-5 p-md-3">
          ...
          <div class="no-postfound"></div>
            ...
            <a class="carousel-control-prev" href="#carouselExampleIndicatorslide" role="button" data-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"><i class="fas fa-arrow-left"></i></span>
            </a>
            <a class="carousel-control-next" href="#carouselExampleIndicatorslide" role="button" data-slide="next">
              <span class="carousel-control-next-icon" aria-hidden="true"><i class="fas fa-arrow-right"></i></span>
            </a>
        </div>
      </div>
